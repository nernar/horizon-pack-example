...
public class TextInputProxyEditTextbox extends EditText {
    ...
    public TextInputProxyEditTextbox(Context context, int allowedLength, boolean limitInput) {
        ...
        InputFilter[] filters = limitInput ? new InputFilter[]{new InputFilter.LengthFilter(this.allowedLength), new InputFilter() { // from class: com.mojang.minecraftpe.TextInputProxyEditTextbox.1
