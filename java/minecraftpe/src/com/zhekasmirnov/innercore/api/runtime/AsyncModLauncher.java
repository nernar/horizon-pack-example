...
public class AsyncModLauncher {
    ...
    public void launchModsInCurrentThread() {
        ...
        // TODO(instant): NativeAPI.setTileUpdateAllowed(true);
        ...
        // TODO(instant): NativeAPI.setInnerCoreVersion(Version.INNER_CORE_VERSION.toString());

        // prepare registries
        // TODO(instant): VanillaIdConversionMap.getSingleton().reloadFromAssets();
        VanillaIdConversionMap.getSingleton().loadScopedIdMapFromAssets(); // TODO(instant)
        BlockRegistry.onInit();
        LibraryRegistry.loadAllBuiltInLibraries();
        LibraryRegistry.prepareAllLibraries();     
        // TODO(instant): FurnaceRecipeRegistry.loadNativeRecipesIfNeeded();
        ...
        // TODO(instant): ItemIconSource.generateAllModItemModels();
